...
interface ViewRecentUserModalProps {
  isViewModalVisible: boolean;
  handleCancel: () => void;
  currentRecord: any;
}
const ViewRecentUserModal: React.FC<ViewRecentUserModalProps> = ({
  isViewModalVisible,
  handleCancel,
  currentRecord,
}) => {
          ...
          <div className="my-5">
            <div className="text-xs sm:text-sm lg:text-base  mt-3">
              ...
              <div className="flex items-center justify-between border-b border-input-color py-1  gap-2 mb-2">
                ...
                <span>{currentRecord?.userType}</span>
              </div>
              <div className="flex items-center justify-between border-b border-input-color py-1  gap-2 mb-2">
...
export default ViewRecentUserModal;
